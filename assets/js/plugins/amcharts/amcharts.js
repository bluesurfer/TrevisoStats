...
(function () {
    ...
    d.AxisBase = d.Class({
        construct: function (a) {
            ...
            this.bcn = "axis-";
            this.centerLabels = !1;
            this.periods = [{period: "ss", count: 1}, {period: "ss", count: 5}, {period: "ss", count: 10}, {period: "ss", count: 30}, {period: "mm", count: 1}, {
                period: "mm",
                count: 5
            }, {period: "mm", count: 10}, {period: "mm", count: 30}, {period: "hh", count: 1}, {period: "hh", count: 3}, {period: "hh", count: 6}, {period: "hh", count: 12}, {period: "DD", count: 1}, {period: "DD", count: 2}, {period: "DD", count: 3}, {period: "DD", count: 4}, {period: "DD", count: 5}, {period: "WW", count: 1}, {period: "MM", count: 1}, {period: "MM", count: 2}, {period: "MM", count: 3}, {period: "MM", count: 6}, {period: "YYYY", count: 1}, {
                period: "YYYY",
                count: 2
            ...
            if (a) {
                ...
                var g = h.width, h = h.height, k = this.viW, l = this.viH, m = 0, n = a.getBBox().height / 2, q = this.inside, p = this.titleAlign;
        ...
        getBBox: function () {
            ...
            var u, w = this.gridAlpha, A, v = this.choosePeriod(0), x = v.period, v = v.count, y = d.getPeriodDuration(x, v);
            y < k && (x = g.period, v = g.count, y = k);
            g = x;
            "WW" == g && (g = "DD");
            this.stepWidth = this.getStepWidth(this.timeDifference);
            var B = Math.ceil(this.timeDifference / y) + 5, D = l = d.resetDateToMin(new Date(this.startTime - y), x, v, r).getTime();
            if (g == x && 1 == v && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels)n = y * this.stepWidth, this.autoWrap && !this.centerLabels && (n = -n);
            ...
            if (0 < this.gridCountR)for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                this.pushAxisItem(m);
                m = l = p;
                if (!isNaN(u))for (h = 1; h < v; h += u)this.gridAlpha = this.minorGridAlpha, f = p + A * h, f = d.resetDateToMin(new Date(f), x, u, r).getTime(),
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
                var m = this.labelFrequency, n = this.showFirstLabel, q = this.showLastLabel, p = 1;
                f = 0;
                ...
                var A, v = this.guides, x = v.length;
                if (0 < x) {
                ...
                var u = this.step, G, v = this.minorGridAlpha;
                this.minorGridEnabled && (G = this.getMinorGridStep(u, this.stepWidth * u));
                if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) &&
                                                                                                                                                                                                                          (this.labelRotationR = this.autoRotateAngle), g = f; g < r; g += p)if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)if (isNaN(w) || Number(d.toFixed(c, w)) == c) {
            ...
            "100% stacked" == b && (b = "100%");
            this.stackType = b;
            var c = [], e = [], h = [], f = [], g, k = this.chart.graphs, l, m, n, q, p = this.baseValue, r = !1;
            if ("line" == a || "step" == a || "smoothedLine" == a)r = !0;
            if (r && ("regular" == b || "100%" == b))for (q = 0; q < k.length; q++)n = k[q], n.hidden || (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable &&
            ...
            for (e = a; e <= b; e++) {
                ...
                for (f in d)if (d.hasOwnProperty(f)) {
                    ...
                    if (g.includeInMinMax && (!g.hidden || this.includeHidden)) {
                        ...
                        var k;
                        if (this.minMaxField)k = g[this.minMaxField], k < c && (c = k); else for (var l in g)g.hasOwnProperty(l) &&
            ...
            for (b = this.start; b <= this.end; b++) {
                ...
                for (e in c)if (c.hasOwnProperty(e)) {
                    ...
                    if (d.includeInMinMax && (!d.hidden || this.includeHidden)) {
                        ...
                        var f;
                        if (this.minMaxField)f = d[this.minMaxField], f > a && (a = f); else for (var g in d)d.hasOwnProperty(g) && "percents" != g &&
            ...
            var c = this.chart;
            "xy" == c.type ? (b < a && (c = b, b = a, a = c), a < this.min && (a = this.min), b > this.max && (b = this.max), c = {type: "axisSelfZoomed"}, c.chart = this.chart, c.valueAxis = this, c.multiplier = this.axisWidth /
...
(function () {
    ...
    d.RecAxis = d.Class({
        construct: function (a) {
            var b = a.chart, c = a.axisThickness, e = a.axisColor, h = a.axisAlpha, f = a.offset, g = a.dx, k = a.dy, l = a.viX, m = a.viY, n = a.viH, q = a.viW, p = b.container;
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            l || (l = 0);
            void 0 == e && (e = !0);
            var r = p.fontFamily, t = a.fontSize;
            void 0 == t && (t = p.fontSize);
            var u = a.color;
            void 0 == u && (u = p.color);
            void 0 !== n && (u = n);
            var w = a.chart.container, A = w.set();
            this.set = A;
            var v = a.axisThickness, x = a.axisColor, y = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, J = a.gridColor, G = a.dashLength, K = a.fillColor, I = a.fillAlpha, X = a.labelsEnabled;
            n = a.labelRotationR;
            var fa = a.counter, P = a.inside, oa = a.labelOffset, qa = a.dx, ka = a.dy, Ra = a.orientation, ca = a.position, aa = a.previousCoord, V = a.viH, sa = a.viW, ba = a.offset, ea, ta;
            ...
            var S = n * Math.PI / 180, W, wa, E = 0, z = 0, la = 0, ha = W = 0, Ja = 0;
            "V" == Ra && (n = 0);
            var Z;
            ...
            Z && (Z.attr({"text-anchor": ga}), Z.translate(E,
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            this.prefixesOfSmallNumbers = [{number: 1E-24, prefix: "y"}, {
                number: 1E-21,
                prefix: "z"
            }, {number: 1E-18, prefix: "a"}, {number: 1E-15, prefix: "f"}, {number: 1E-12, prefix: "p"}, {number: 1E-9, prefix: "n"}, {number: 1E-6, prefix: "\u03bc"}, {number: .001, prefix: "m"}];
            ...
            if (d.ifArray(b)) {
                ...
                for (e = 0; e < b.length; e++) {
                    ...
                    if (!1 !== h.enabled) {
                        ...
                        isNaN(h.alpha);
                        var k = this.marginLeft, f = d.wrappedText(this.container, h.text, f, this.fontFamily, g, "middle", !1, this.divRealWidth - 32);
            ...
            this.zoomButtonSet && this.zoomButtonSet.remove(), this.zbSet && (this.zbSet.remove(), this.zbSet = null), this.zoomButtonSet = a.set(), this.linkSet && this.linkSet.remove(), this.linkSet = a.set()) : this.fire("failed", {type: "failed", chart: this})
        }, premeasure: function () {
            var a = this.div;
            if (a) {
        ...
        animate: function (a, b, c, e, h, f, g) {
            ...
            if (!this.hideCredits) {
                var a = "amcharts.com", b = window.location.hostname.split("."),
                    c;
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
            ...
            isNaN(this.precision) || (this.numberFormatter ? this.numberFormatter.precision = this.precision : this.numberFormatter = {
                precision: this.precision, decimalSeparator: a.decimalSeparator,
        ...
        createGraph: function () {
            ...
            for (d = this.start; d <= this.end; d++) {
                var f =
                    this.data[d].axes[c.id].graphs[this.id], g = f.values, k = g.x, l = g.y, g = c.getCoordinate(k, this.noRounding), m = e.getCoordinate(l, this.noRounding);
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q))this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    var r = this.y - (this.valueAxis.getCoordinate(q, this.noRounding) - this.height), r = r * this.valueAxis.rMultiplier, t = 180 - 360 / (this.end - this.start + 1) * m;
                    ...
                    if (!isNaN(p)) {
                        var u = this.y - (this.valueAxis.getCoordinate(p,
                                this.noRounding) - this.height), u = u * this.valueAxis.rMultiplier, w = u * Math.sin(t / 180 * Math.PI), t = u * Math.cos(t / 180 * Math.PI);
                        e.push(w);
                        d.push(t);
                        isNaN(k) && (k = w);
                        isNaN(l) && (l = t)
            ...
            if (e) {
                var l = e.graphDataItem, m = this.chart.rotate, n = l.isNegative, q = this.chart, p = this.valueAxis;
                b -= k.height / 4 / 2;
            ...
            var a = this.chart,
                b = this.id, c = this.index, e = this.data, h = this.chart.container, f = this.valueAxis, g = this.type, k = this.columnWidthReal, l = this.showBulletsAt;
            isNaN(this.columnWidth) || (k = this.columnWidth);
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, r = this.rotate, t = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), w = this.connect, A = [], v = [], x, y, B, D, C = this.chart.graphs.length, J, G = this.dx / this.tcc, K = this.dy / this.tcc, I = f.stackType, X = this.start, fa = this.end, P = this.scrollbar, oa = "graph-column-";
            P && (oa = "scrollbar-graph-column-");
            var qa = this.categoryAxis, ka = this.baseCoord, Ra = this.negativeBase, ca = this.columnIndex, aa = this.lineThickness, V = this.lineAlpha, sa = this.lineColorR, ba = this.dashLength, ea = this.set, ta, ga = this.getGradRotation(), S = this.chart.columnSpacing, W = qa.cellWidth, wa = (W * k - t) / t;
            S > wa && (S = wa);
            var E, z, la, ha = q + 1, Ja = n + 1, Z = 0, qb = 0, rb, sb, eb, fb, tb = this.fillColorsR, Ka = this.negativeFillColors, Da = this.negativeLineColor, Wa = this.fillAlphas, Xa = this.negativeFillAlphas;
            ...
            if (!(P || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ka && void 0 == Da || m))) {
                ...
                var Ga = f.getCoordinate(Sa), Lb = f.getCoordinate(f.max);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < X) {
                    for (L = X - 1; -1 < L; L--)if (E = e[L], z = E.axes[f.id].graphs[b], la = z.values.value, !isNaN(la)) {
                        X = L;
                        break
                    }
                    if (this.lineColorField)for (L = X; -1 < L; L--)if (E = e[L], z = E.axes[f.id].graphs[b], z.lineColor) {
                        this.bulletColorSwitched = this.lineColorSwitched = z.lineColor;
                        break
                    }
                    if (this.fillColorsField)for (L = X; -1 < L; L--)if (E = e[L], z = E.axes[f.id].graphs[b], z.fillColors) {
                        this.fillColorsSwitched = z.fillColors;
                        break
                    }
                    if (this.dashLengthField)for (L = X; -1 < L; L--)if (E = e[L], z = E.axes[f.id].graphs[b],
                            !isNaN(z.dashLength)) {
                        this.dashLengthSwitched = z.dashLength;
                        break
                    }
                }
                if (fa < e.length - 1)for (L = fa + 1; L < e.length; L++)if (E = e[L], z = E.axes[f.id].graphs[b], la = z.values.value, !isNaN(la)) {
                    fa = L;
                    break
                }
            }
            ...
            var Nb = this.noStepRisers, hb = -1E3, ib = -1E3, jb = this.minDistance, Ma = !0, Ya = !1, vb = 0, wb = 0;
            for (L = X; L <= fa; L++) {
                E = e[L];
                ...
                var Za, Na = NaN;
                if (m && void 0 ==
                    this.openField)for (var xb = L + 1; xb < e.length && (!e[xb] || !(Za = e[L + 1].axes[f.id].graphs[b]) || !Za.values || (Na = Za.values.value, isNaN(Na))); xb++);
                var Q, O, M, da, ma = NaN, H = NaN, F = NaN, R = NaN, N = NaN, Oa = NaN, Ea = NaN, Pa = NaN, Fa = NaN, xa = NaN, ya = NaN, ia = NaN, ja = NaN, Y = NaN, yb = NaN, zb = NaN, na = NaN, pa = void 0, Ia = tb, Ta = Wa, Ba = sa, ua, za, Ab = this.proCandlesticks, kb = this.topRadius, $a = this.pattern;
                ...
                if (Ca) {
                    ...
                    var ma = E.x[qa.id], Ua = this.periodSpan - 1;
                    "step" != g || isNaN(E.cellWidth) || (W = E.cellWidth);
                    var ra = Math.floor(W / 2) + Math.floor(Ua * W / 2), Aa = ra, lb = 0;
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(Y))w ||
                            (this.drawLineGraph(A, v, T, U), A = [], v = [], T = [], U = []); else {
                            ...
                            break;
                        case "smoothedLine":
                            if (isNaN(Y))w || (this.drawSmoothedGraph(A, v, T, U), A = [], v = [], T = [], U = []); else {
                                if (Math.abs(H - hb) >= jb || Math.abs(F - ib) >= jb)A.push(H), v.push(F), hb = H, ib = F;
                                xa = H;
                                ya = F;
                                ia = H;
                                ja = F;
                                !La || isNaN(N) || isNaN(R) || (T.push(R), U.push(N));
                                void 0 == z.lineColor && void 0 == z.fillColors && isNaN(z.dashLength) || (this.drawSmoothedGraph(A, v, T, U), A = [H], v = [F], T = [], U = [],
                                !La || isNaN(N) || isNaN(R) || (T.push(R), U.push(N)), this.lineColorSwitched = z.lineColor, this.fillColorsSwitched = z.fillColors, this.dashLengthSwitched = z.dashLength);
                        ...
                        case "step":
                            if (!isNaN(Y)) {
                                ...
                                if (Ya || void 0 != z.lineColor || void 0 != z.fillColors || !isNaN(z.dashLength)) {
                                    var bc = A[A.length - 2], cc = v[v.length - 2];
                                    A.pop();
                                    v.pop();
                        ...
                        case "column":
                            ...
                            if (!isNaN(Y)) {
                                ...
                                if (pa && (za = pa.set, d.setCN(a, pa.set, "graph-" + this.type), d.setCN(a, pa.set, "graph-" + this.id), z.className && d.setCN(a, pa.set, z.className, !0), z.columnGraphics = za, za.translate(Q, O), this.columnsSet.push(za), (z.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), !P)) {
                                    ...
                                    this.columnsArray.push({column: pa, depth: J});
                                    z.x = r ? O + M / 2 : Q + M / 2;
                        ...
                        case "candlestick":
                            if (!isNaN(na) && !isNaN(Y)) {
                                ...
                                if (r) {
                                    ...
                                    Ab && Y >= na && (Ta = 0);
                                    var pa = new d.Cuboid(h, M, da, G, K, Ia, Ta, aa, ua, V, ga, u, r, ba, $a, kb, oa), Eb, Fb;
                        ...
                        case "ohlc":
                            if (!(isNaN(na) || isNaN(yb) || isNaN(zb) || isNaN(Y))) {
                                ...
                                var mb, nb, ob;
                                if (r) {
                                    var Gb = F - k / 2, Gb = d.fitToBounds(Gb, 0, q), Sb = d.fitToBounds(F, 0, q), Hb = F + k / 2, Hb = d.fitToBounds(Hb, 0, q);
                                    ...
                                    var Ib = H - k / 2, Ib = d.fitToBounds(Ib, 0, n), Tb = d.fitToBounds(H, 0, n), Jb = H + k / 2, Jb = d.fitToBounds(Jb, 0, n);
                    ...
                    if (!P && !isNaN(Y)) {
                        ...
                        if (this.end - this.start <= Ub || 0 === Ub) {
                            var Vb = this.createBullet(z, ia, ja, L), Wb = this.labelText;
                            if (Wb && Vb) {
                            ...
                            if ("regular" == I || "100%" == I) {
                                ...
                                if (Xb) {
                                    ...
                                    var Yb = Qa.getBBox(),
                                        Zb = Yb.width, $b = Yb.height, bb, cb, pb = f.totalTextOffset, ac = f.totals[L];
                                    ac && ac.remove();
                                    var db = 0;
            ...
            if (1 < a.length) {
                ...
                g.push(n);
                g.push(m);
                var q = h.lineAlpha, p = h.lineThickness,
                    g = h.fillAlphas, r = h.lineColorR, t = h.negativeLineAlpha;
                isNaN(t) && (t = q);
                ...
                var w = h.negativeLineColor, v = h.negativeFillColors, x = h.negativeFillAlphas, y = h.baseCoord;
                ...
                if (0 < g || 0 < x)if (p = a.join(";").split(";"), t = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), t = b.concat(e)) : "radar" == q ? (t.push(0), p.push(0)) : h.rotate ? (t.push(t[t.length -
            ...
            if (1 < a.length) {
                ...
                h.push(l);
                h.push(k);
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR, r = this.fillColorsR, t = this.negativeLineColor, u = this.negativeFillColors, w = this.negativeFillAlphas, A = this.baseCoord, v = this.lineColorSwitched;
                v && (p = v);
            ...
            if (0 < b && !a.animationPlayed) {
                ...
                d.VML ||
                (c.attr({opacity: a.startAlpha}), e.attr({opacity: a.startAlpha}));
                c.hide();
                e.hide();
            ...
            b && (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3), c.translate(e, -1E3)), b.animate({opacity: 1, translate: e + "," + d}, f, a), c.animate({
                opacity: 1,
                translate: e + "," + d
            }, f, a))
        }, animate: function (a) {
        ...
        hideCustomBullets: function () {
            ...
            if (a) {
                var c = this.chart, e = {type: "rollOverGraphItem", item: a, index: a.index, graph: this, target: this, chart: this.chart, event: b};
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            if (this.enabled) {
                ...
                var k = e.categoryAxis, l = e.dx, m = e.dy, n = this.x + 1, q = this.y + 1, p = this.width, r = this.height, t = this.data[a], u;
                this.data[a + 1] && (u = this.data[a + 1]);
                this.fireMoved();
                if (t) {
                    var w = t.x[k.id], A = e.rotate, v = this.stepWidth, x = this.categoryBalloon, y = this.firstTime, B = this.lastTime, D = this.cursorPosition, C = this.zooming, J = this.panning, G = e.graphs;
                    if (e.mouseIsOver || C || J || this.forceShow)if (this.forceShow = !1, J) {
                        b = this.panClickPos;
                        a = this.panClickEndTime;
                        var e = this.panClickStartTime, C = this.panClickEnd, K = this.panClickStart, f = (A ? b - g : b - f) / v;
                        if (!k.parseDates || k.equalSpacing)f = Math.round(f);
                        0 !== f && (b = {type: "zoomed", target: this}, b.chart = this.chart, k.parseDates && !k.equalSpacing ? (a + f > B && (f = B - a), e + f < y && (f = y - e), b.start = Math.round(e + f), b.end = Math.round(a + f), this.fire(b.type, b)) : C + f >= this.data.length || 0 > K + f || (b.start = K + f, b.end = C + f, this.fire(b.type, b)))
                    } else {
                        "start" == D ? w -= k.cellWidth / 2 : "mouse" == D && (e.mouseIsOver ?
                            w = A ? g - 2 : f - 2 : isNaN(this.tempPosition) || (w = this.tempPosition - 2));
                        if (A) {
                            if (0 > w)if (C)w = 0; else {
                                this.hideCursor();
                                return
                            }
                            if (w > r + 1)if (C)w = r + 1; else {
                                this.hideCursor();
                                return
                            }
                        } else {
                        ...
                        if (!c && (a != this.previousIndex || K != this.previousMostCloseGraph) && (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], G && this.valueBalloonsEnabled && B && e.balloon.enabled)) {
                            ...
                            for (k = 0; k < G.length; k++)if (x = G[k], y = NaN, (!this.oneBalloonOnly || x == K) && x.showBalloon && !x.hidden &&
                                ...
                                if (this.showNextAvailable && isNaN(y) && a + 1 < this.data.length)for (B = a + 1; B < this.data.length; B++)if (w = this.data[B])if (u = w.axes[x.valueAxis.id].graphs[x.id], y = u.y, !isNaN(y))break;
                                if (!isNaN(y)) {
                                    w = u.x;
                                    v = !0;
                                    if (A) {
                                    ...
                                    (v.color = x.balloonTextColor), v.setPosition(B + n, w + q), B = e.formatString(x.balloonText, u, !0), (w = x.balloonFunction) && (B = w(u, x).toString()), "" !== B && (A ? v.showBalloon(B) : (v.text = B, v.show = !0), c.push({yy: y, balloon: v})), !A && v.set && (v.set.hide(), x = v.textDiv) && (x.style.visibility = "hidden"))
                                }
                            }
                            this.avoidBalloonOverlapping && this.arrangeBalloons()
                        }
                        b ? (b = {type: "changed"}, b.index = a, b.chart = this.chart, b.zooming = C, b.mostCloseGraph = K, b.position = A ? g : f, b.target = this, e.fire("changed", b), this.fire("changed", b), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, e.updateLegendValues(a));
            ...
            var d = b.position, f = b.inside;
            b = b.axisThickness;
            var g = this.chart, k = g.dx, g = g.dy, l = this.x, m = this.y, n = this.width, q = this.height;
            ...
            var e = b.position, d = b.inside, f = b.axisThickness, g = b.tickLength, k = this.chart, l = k.dx, k = k.dy, m = this.x, n = this.y, q = this.width, p = this.height;
            ...
            if (a) {
                ...
                if (this.drawingNow) {
                    ...
                    if (2 < Math.abs(c - e) || 2 < Math.abs(f - h))c = {type: "draw", target: this, chart: a, initialX: c, initialY: f, finalX: e, finalY: h}, this.fire(c.type, c)
                }
                if (this.enabled && 0 <
                    b.length) {
                    if (this.pan)this.rolledOver = !1; else if (this.zoomable && this.zooming) {
                        ...
                        b[c.end] && (c.end = a.getEndTime(b[c.end].time))), this.skipZoomDispatch || this.fire(c.type, c)); else {
        ...
        construct: function (a) {
            ...
            if (k) {
                c =
                    k.x + d;
                e = k.y + f;
                var l = k.width, k = k.height, m = this.rotate, n = this.chart, q = this.width, p = this.height, r = n.mouseX, t = n.mouseY;
                a = this.initialMouse;
            ...
            if (a.enabled) {
                ...
                if (m = a.graph) {
                    ...
                    for (r = 0; r < c.length; r++) {
                        var t = c[r].axes[p.id].graphs[m.id].values, u;
    ...
    d.AmBalloon = d.Class({
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    var g = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, q = this.fillColor, p = this.borderColor, r = q;
                    void 0 != n && (this.adjustBorderColor ? r = p = n : q = n);
                    var t = this.horizontalPadding, u = this.verticalPadding, w = this.pointerWidth, A = this.pointerOrientation, v = this.cornerRadius, x = c.fontFamily, y = this.fontSize;
                    ...
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    var k = y + u, m = D + t, u = this.shadowAlpha, G = this.shadowColor, t = this.borderThickness, K = this.bulletSize, I;
...
(function () {
    ...
    d.AmSlicedChart = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            e && 0 < c && (0 < a.alpha && e.show(), e.translate(a.startX, a.startY), e.animate({opacity: 1, translate: "0,0"}, c, this.startEffect))
        }, showLabels: function () {
            var a =
                this.chartData, b;
            for (b = 0; b < a.length; b++) {
...
(function () {
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, t = a.initialXValue, u = a.finalXValue, w = a.initialValue, A =
                a.finalValue, v = p.recalculateToPercents, x = b.dataDateFormat;
...
(function () {
    ...
    d.bullet = function (a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        switch (b) {
            ...
            case "rectangle":
                r = d.polygon(a,
                    [-c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, h, f, g, k, m - 180, void 0, p);
                break;
            case "diamond":
    ...
    d.makeHD = function (a, b, c) {
        for (var e = [], d = [], f = 1; f < a.length; f++)for (var g = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.round(Math.sqrt(Math.pow(l - g, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - g) / n, m = (m - k) / n, q = 0; q <= n; q++) {
            var p = g + q * l + Math.random() * c, r = k + q * m + Math.random() * c;
            e.push(p);
            d.push(r)
        }
        return [e, d]
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p) {
        ...
        g = r(g);
        k = r(k);
        var t = r(g / f * k), u = d.VML, w = 359.5 + f / 100;
        359.94 < w && (w = 359.94);
        h >= w && (h = w);
        var A = 1 / 180 *
            Math.PI, w = b + Math.sin(e * A) * k, v = c - Math.cos(e * A) * t, x = b + Math.sin(e * A) * f, y = c - Math.cos(e * A) * g, B = b + Math.sin((e + h) * A) * f, D = c - Math.cos((e + h) * A) * g, C = b + Math.sin((e + h) * A) * k, A = c - Math.cos((e + h) * A) * t, J = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, G = 0;
        180 < Math.abs(h) && (G = 1);
        e = a.set();
        var K;
    ...
    d.VMLRenderer = d.Class({
        ...
        text: function (a, b, c) {
            ...
            for (h = 0; h < b.length; h++) {
                ...
                "Z" == g && (a += " x e");
                if ("Q" == g) {
                    var m = c.length, n = c[m - 1], q = k[0], p = k[1], l = k[2], r = k[3];
                    c = d(c[m - 2] / 3 + 2 / 3 * q);
                    n = d(n / 3 + 2 / 3 * p);
                    q = d(2 / 3 * q + l / 3);
                    p = d(2 / 3 * p + r / 3);
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, h = this.marginBottom, f = this.horizontalGap,
                g = this.div, k = this.divWidth, l = this.maxColumns, m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, r = 0, t = this.container;
            this.set && this.set.remove();
            var u = t.set();
            this.set = u;
            var w = t.set();
            u.push(w);
            var A = this.entries, v, x;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)g = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), g.push(n), a.bullet && (a.hidden || (e = a.bulletColorR),
                        n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), p = 0, n = m, q = m / 3; else {
                        var r;
...
(function () {
    ...
    d.formatDate = function (a, b, c) {
        ...
        var p = String(e).substr(2, 2), r = "0" + g;
        b = b.replace(/W/g,
            q);
        q = k;
        24 == q && (q = 0);
